                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('admin.generator.post') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="controller_namespace" class="form-control"
                                            id="controller_namespace" placeholder="Admin" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="route" class="col-md-4 col-form-label text-right">Want to add
                                        route?</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="relationships"
                                        class="col-md-4 col-form-label text-right">Relationships</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="form_helper" class="form-control" id="form_helper">
                                            ...
                                            <option value="laravelcollective">Laravel Collective</option>
                                        </select>
                                ...
                                <br>
                                <div class="form-group row">
                                    <div class="offset-md-4 col-md-4 buttonGenerate">
