...
namespace Hamdan\CrudGenerator\Commands;
...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if (\App::VERSION() >= '5.3') {
            $routeFile = base_path('routes/crudweb.php');
        }
    ...
    {
        return ["Route::resource('" . $this->routeName . "', " . $this->controller . "Controller::class);"];
    }

    /** Custom code by HAMDAN */
    protected function addNameSpace()
    {
        return ['use App\Http\Controllers\\'. $this->namespace . $this->controller.'Controller;'];
    }
